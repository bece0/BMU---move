<?php 
     ...
     */
    function KullaniciKaydet($kodu, $name, $surname, $email, $password, $salt){
        
        //$password = password_hash($password, PASSWORD_BCRYPT);

        $sql = "INSERT INTO kullanici (kodu, adi, soyadi, email, parola, salt, kayit_tarihi)
        VALUES ('$kodu', '$name', '$surname', '$email', '$password', '$salt', CURDATE())";
