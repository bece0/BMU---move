		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				<div class="col-xs-12 col-sm-4 col-md-4">
					...
					<ul class="list-unstyled quick-links">
						<li><a href="find.php"><i class="fa fa-angle-double-right"></i>Etkinlik Ara</a></li>
						<li><a href="create_evet.php"><i class="fa fa-angle-double-right"></i>Etkinlik Oluştur</a></li>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4">
					<h5>Bilgi</h5>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
					<p class="h6">&copy Tüm Hakları Saklıdır.<a class="text-green ml-2" href="#" target="_blank"> MOVE</a></p>
				</div>
				</hr>
			</div>	
		</div>
