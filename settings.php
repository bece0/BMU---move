                        ...
                        <form id="genel_form">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?php echo $AYARLAR["yeni_etkinlik_mail"] ?>" name="yeni_etkinlik_mail" id="yeni_etkinlik_mail" required <?php if ($AYARLAR["yeni_etkinlik_mail"] == "yes") echo "checked" ?>>
                                    <label class="form-check-label" for="yeni_etkinlik_mail">
                                        Yeni etkinlikler hakkında bildirim almak istiyorum.
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="gecmis_private">
                                        Geçmişte katıldığım etkinlikleri gizle
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="gelecek_private">
                                        Gelecekte katılacağım etkinlikleri gizle
                                    </label>
                                </div>
                            </div>
